...
-   First of all: there was `r table(tab$Trend)[1]` *Decrease*, `r table(tab$Trend)[2]` *Increase* and `r table(tab$Trend)[3]` *Stable* computed trends across the literature.
...
-   Reducing the spatial scales to fewer levels: so far, Local \<= 25 Km², Regional \> 25 Km² National for EUropean size countries and Continental for the sizes of USA and worldwide.
