...
1) How is the trend of biodiversity metrics linked to spatial grain/spatial extent.

* Talk about papers which does compare (Jarzyna Jetz)

* The inconsistence of reporting scales (especially for models, and for MSI metrics)
