...
tab <-
  tab %>%
    ...
    mutate(`Spatial grain (Km²)` = case_when(
      `Spatial grain (Km²)` <= 100 | `Spatial grain (Km²)` == "Local" ~ "Local",
      (`Spatial grain (Km²)` > 100 & `Spatial grain (Km²)` < 800000) | (`Spatial grain (Km²)`== "Admin. unit") | (`Spatial grain (Km²)`== "Regional")~ "Regional",
