...
For the cases where the metric was determined out of model [e.g. @harrison_assessing_2014], the final temporal grain was sometimes explicitly given, with an order of length of the year. 
