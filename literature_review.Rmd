...
**At local scales**, we can see that species richness experiences mostly increases (Figure \ref{fig:barmetricsperspatscale}). Taxonomic and functional diversity indexes are exclusively increasing. Evenness indexes, *i.e.* taxonomic and functional evenness, mainly increase over time. Concerning the abundance indexes, the stability dominates but the increase is also often witnessed. In contrast, **at regional scale**, abundance metrics always decrease, whilst temporal $\beta$-diversity  always increase. Species richness experiments mainly increases, then stability but no decrease is reported. Concerning **national and regional scales**, for birds, one have to keep in mind that spatial replicates are less frequent and that general trends are less reliable. However, no clear decrease seems observed in the scientific literature. For instance, @bowler_geographic_2021 showed negative trends in abundance indexes for Denmark and Germany and positive trends for Switzerland and Czech Republic, indicating that one can not conclude about general trend at national scale.  
