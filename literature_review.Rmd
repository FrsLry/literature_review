...
**About the entanglement of spatial and temporal grain:** there is a relationship between spatial and temporal grain. As the spatial grain increases, the temporal grain is also expected to increase, as a greater spatial scale needs more time to be sampled (sampling for a very short period of time a large area would result in sampling a smaller area). However, the inverse is not true, one can definitely sample a small area for a very long time. 

# Future directions

Out of `r length(unique(tab$Reference))` papers, 5 were located in North America and 12 in Europe. (talk about Fraixedas)

# Conclusion

As birds represent one of the most data furnished taxa of vertebrates, reviewing the scientific literature on this topic gives a glimpse of what still needs to be done to better understand the scaling of global biodiversity dynamic. 
